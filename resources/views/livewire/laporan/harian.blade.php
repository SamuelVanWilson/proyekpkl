<div>
    ...
    <div x-data="{
        ...
        init() {
            ...
            {{-- Tombol aksi (Tambah/Hapus baris, Konfigurasi, Laporan Baru, Simpan, Preview) --}}
            <div class="mt-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-2">
                ...
                {{-- Buat laporan baru --}}
                <button type="button" wire:click="newReport" class="bg-gray-200 hover:bg-gray-300 text-gray-700 px-3 py-2 rounded-lg text-sm font-medium w-full flex items-center justify-center gap-1">
